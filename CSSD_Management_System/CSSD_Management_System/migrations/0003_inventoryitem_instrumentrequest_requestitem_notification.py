# Generated fix: self-contained migration for state-machine branch.
# Replaces the broken 0005 (which depended on a non-existent 0004).
# Creates InventoryItem, InstrumentRequest (with is_archived), RequestItem, Notification.
